...
namespace BlazorDictionary.Common.Models.Responsies
{
    public class RequestResponse : Response
    {
        ...
        public RequestResponse(ResponseStatus status) => Status = status;
        public RequestResponse(ResponseStatus status, HttpResponseMessage httpResponse) : this(status) => HttpResponse = httpResponse;
        public RequestResponse(ResponseStatus status, string message) : base(message) => Status = status;
